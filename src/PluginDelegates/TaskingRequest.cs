...
public partial class PluginDelegates {
    internal (MessageFormats.HostServices.Sensor.TaskingRequest? output_request, MessageFormats.HostServices.Sensor.TaskingResponse? output_response) TaskingRequest((MessageFormats.HostServices.Sensor.TaskingRequest? input_request, MessageFormats.HostServices.Sensor.TaskingResponse? input_response, Plugins.PluginBase plugin) input) {
        ...
        try {
            Task<(MessageFormats.HostServices.Sensor.TaskingRequest? output_request,
                    MessageFormats.HostServices.Sensor.TaskingResponse? output_response)> pluginTask = input.plugin.TaskingRequest(input_request: input.input_request, input_response: input.input_response);
            pluginTask.Wait();
