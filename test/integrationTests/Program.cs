namespace Microsoft.Azure.SpaceFx.PlatformServices.MessageTranslationService.IntegrationTests;

public class Program {
    internal static TestSharedContext TEST_SHARED_CONTEXT = new();
    public static void Main(string[] args) {
        Console.WriteLine("--------- Starting Tests ---------");
        RunTests<Tests.TaskingPreCheckTests>();
        RunTests<Tests.TaskingTests>();
        RunTests<Tests.SensorDataTests>();
        RunTests<Tests.SensorsAvailableTests>();
        RunTests<Tests.LinkTests>();
